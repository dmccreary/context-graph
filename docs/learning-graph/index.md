# Learning Graph for Context Graph
...
This textbook contains 496 concepts spanning 18 topics plus cross-cutting concept areas.
...
- Connectivity: 1 connected component, 0 orphaned nodes
...
- Category organization - foundational graph and data elements first, compliance and infrastructure last
- Balanced categories (5.0% - 13.3% each)
