...
|---|---------|-------|--------|-------|
| 1 | Concepts | 496 | Required | Concepts from learning graph |
...
| 5 | Chapter Quizzes | 22 / 22 | Recommended | Chapters with a quiz.md (220 questions total) |
| 6 | Chapter References | 22 / 22 | Recommended | Chapters with references.md (220 references total) |
| 7 | Glossary Terms | 498 | Recommended | Defined terms in glossary.md |
| 8 | FAQs | 85 | Recommended | Questions in faq.md |
| 9 | Words | 216,939 | Required | Words across student-facing markdown |
...
|-------------|-------------|---------------|-------|
| Diagrams | 44 | 44 | H4 headers starting with '#### Diagram:' |
| Equations | 3 | 2 | LaTeX expressions (inline and display) |
| Total Words | 216,939 | 145,504 | Words in markdown files |
| Links | 615 | 248 | Hyperlinks in markdown format |
| Equivalent Pages | 901 | 616 | Estimated pages (250 words/page + visuals) |
