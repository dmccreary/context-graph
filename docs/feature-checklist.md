...
| Feature | Status | Effort | Notes |
|---------|--------|--------|-------|
| Glossary | :white_check_mark: | Medium | 498 terms with ISO 11179 compliant definitions |
...
| Feature | Status | Effort | Notes |
|---------|--------|--------|-------|
| MicroSims (interactive simulations) | :white_check_mark: | High | 47 browser-based apps for hands-on learning |
...
| Feature | Status | Effort | Notes |
|---------|--------|--------|-------|
| Chapter content | :white_check_mark: | Very High | 22 chapters with full text, examples, and exercises |
